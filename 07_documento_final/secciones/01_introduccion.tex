...
El documento incluye también un diccionario de datos completo, validaciones ejecutadas sobre Oracle 19c, una comparación técnica entre la tesis base y la transformación realizada hacia Oracle 19c, y una verificación funcional de la aplicación Laravel desarrollada por el equipo para LALYSDENT. Esta ejecución se realizó en un schema separado para evidenciar el sistema web del proyecto, sin reemplazar el schema diseñado en el examen.
