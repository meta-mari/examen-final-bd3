...
\subsection{Fuentes externas consideradas}

Se consideraron dos fuentes externas principales. La primera fue el repositorio académico de la tesis base, disponible en \url{https://calvocobos.github.io/}, usado como fuente documental del dominio LALYSDENT. La segunda fue el repositorio Laravel \url{https://github.com/AlanDevPro/sistema-odontologico}, clonado y ejecutado localmente para comprobar una aplicación funcional relacionada con el mismo dominio \parencite{calvocobos2025web,sistemaodontologicogithub}.

El uso de estas fuentes no cambia el alcance principal del examen. El producto central sigue siendo la base de datos Oracle 19c diseñada, implementada y validada en el schema \texttt{FARMACIAS\_BD3}.
