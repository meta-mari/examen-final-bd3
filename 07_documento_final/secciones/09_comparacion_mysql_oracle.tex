...
\subsection{Diferencia entre diseño de base de datos y aplicación Laravel}

La comparación anterior se basa en dos niveles complementarios. El primer nivel es documental: la tesis y su sitio web permiten identificar el dominio funcional, los módulos principales y el contexto del sistema LALYSDENT. El segundo nivel es de ejecución: la aplicación Laravel desarrollada por el equipo permitió verificar el funcionamiento del sistema web con Oracle, migraciones, seeders, autenticación y módulos operativos.

Aun así, el diseño \texttt{FARMACIAS\_BD3} no se presenta como una copia automática del schema usado por la aplicación Laravel. La base del examen fue elaborada como diseño independiente, con modelo conceptual Chen, transformación relacional, modelo lógico Crow's Foot, diseño físico Oracle 19c, diccionario de datos, validaciones y objetos PL/SQL propios. La aplicación Laravel se usa como implementación web del mismo proyecto para reforzar el análisis del dominio y comprobar el funcionamiento del sistema en un entorno separado.
